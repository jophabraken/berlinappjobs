...
for step in ['build_seo.py', 'build_programmatic.py', 'build_jobpages.py', 'build_programmatic.py', 'build_seo.py', 'build_programmatic.py', 'cleanup_stale.py', 'build_home.py']:
